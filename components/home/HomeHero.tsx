      ...
      <div className="container flex flex-col items-center justify-center gap-12 px-4 py-16">
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <p className="max-w-2xl text-lg text-muted-foreground">
            Product catalog, cart, checkout, and order history. Built with
            Next.js, TypeScript, Tailwind, Prisma — portfolio project.
          </p>
        </div>
        ...
        <div className="mt-8 rounded-lg border border-border bg-muted/50 p-6 text-sm text-muted-foreground">
          ...
          <ul className="mt-2 list-inside list-disc space-y-1">
            <li>
              Edit <code className="rounded bg-muted px-1.5 py-0.5">.env</code>{" "}
              with your{" "}
            ...
            <li>
              Implement features per{" "}
              <code className="rounded bg-muted px-1.5 py-0.5">docs/rules</code>
            </li>
          </ul>
        </div>
      </div>
